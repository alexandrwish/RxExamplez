...
import com.magenta.mc.client.android.smoke.SmokeApp;
...
public class MxMobile extends SmokeApp {
    ...
    protected void setupLoginListener() {
        ...
        Login.getInstance().setListener(new Login.Listener() {
            ...
            public void successAfterWake(final boolean initiatedByUser) {
                ...
                if (initiatedByUser) {
                    successAfterWakeInitiatedByUser();
                }
            }
    ...
    protected void successAfterWakeInitiatedByUser() {

    }

    protected void afterLogoutApplication() {
    ...
    protected void setupConnectionListener() {
        ...
        ConnectionListener.getInstance().setListener(new ConnectionListener.Listener() {
            public void connected() {
                ...
                if (currActivity instanceof GenericActivity) {
                    ((GenericActivity) currActivity).getDelegate().setDriverStatus(DriverStatus.ONLINE);
                }
            ...
            public void disconnected() {
                ...
                Activity currActivity = ((AndroidUI) Setup.get().getUI()).getCurrentActivity();
                if (currActivity instanceof GenericActivity) {
                    ((GenericActivity) currActivity).getDelegate().setDriverStatus(DriverStatus.OFFLINE);
                }
