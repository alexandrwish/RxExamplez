...
public class RandomBinaryTransmitter {
    ...
    private final static Mutex taskProcessMutex = new Mutex();
    private final static Map<String, Boolean> runningTasks = new HashMap<>();
        ...
        public void sent(ResendableMetadata metadata, String id, Object[] params) {
            if (params != null && params.length == 2) {
                try {
                    ...
                    boolean lastChunk = (Boolean) params[1];
    ...
    private RandomBinaryTransmitter() {
        initThreadPool();
    }
