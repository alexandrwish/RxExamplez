...
public class Strconv {
    ...
    /* test
        byte b1[]={1,2,3,4};
        String b64=jaba.util.Strconv.toBase64(b1, -1);
        byte bo[]=jaba.util.Strconv.fromBase64(b64);
        
        byte b2[]={1,2,3};
        b64=jaba.util.Strconv.toBase64(b2, -1);
        bo=jaba.util.Strconv.fromBase64(b64);
        
        byte b3[]={1,2};
        b64=jaba.util.Strconv.toBase64(b3, -1);
        bo=jaba.util.Strconv.fromBase64(b64);

        byte b4[]={1};
        b64=jaba.util.Strconv.toBase64(b4, -1);
        bo=jaba.util.Strconv.fromBase64(b64);
    */
