...
package com.magenta.mc.client.android.mc.io;
...
public class DnsSrvResolver {
    ...
    private boolean getCachedSrv() {
        ...
        try {
            ...
            if (ttl > Time.utcTimeMillis()) {
                System.out.println("Srv storage hit");
                return true;
            }
            System.out.println("Srv storage expired");

        } catch (Exception e) {
            System.out.println("Srv storage missed");
        }*/
        return false;
    }
    ...
    private boolean askInetSrv() {
        ...
        try {
            ...
            Hashtable ht = new jaba.util.StringLoader().hashtableLoader(c.openInputStream());
