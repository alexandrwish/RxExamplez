...
public class RPCOut extends DefaultRpcResponseHandler {
    ...
    private static final String CHECK_IMEI = "checkImei";
    private static final String UPDATE_IMEI = "updateImei";
    private static final String RELOAD_JOBS = "reloadJobs";
    private static final String USER_LOGGED = "processPerformerLogging";
    private static final String RELOAD_JOBS_HISTORY = "reloadJobsHistory";
    private static final String CREATE_UNAVAILABILITY = "createUnavailability";
    private static final String REQUEST_ACCOUNT_CONFIGURATION = "accountConfiguration";
    ...
    public static void jobStates(long id, String userId, String jobRef, String states, Map values) {
        HttpClient.getInstance().sendState(id, userId, jobRef, states, values);
    }
