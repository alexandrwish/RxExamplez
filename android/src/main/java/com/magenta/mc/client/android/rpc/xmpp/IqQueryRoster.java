...
public class IqQueryRoster extends Iq {
    ...
    /*public IqQueryRoster( XMLDataBlock _parent, Hashtable _attributes )
   {
    ...
    */
    ...
    public IqQueryRoster(String jid, String name, String group, String subscription) {
        ...
        XMLDataBlock qB = addChildNs("query", "jabber:iq:roster");
        XMLDataBlock item = qB.addChild("item", null);
