...
/**
 * This import java.jaba.util.Vector;
 * <p>
 * class is the equivalent to the <code>PatternLayout</code> found in
...
public class MCPatternFormatter implements Formatter {
     ...
     * net.sf.microlog.core.Level, Object, Throwable)
     */
    ...
    /**
     * @see net.sf.microlog.core.Formatter#setProperty(String,
     * String)
     */
