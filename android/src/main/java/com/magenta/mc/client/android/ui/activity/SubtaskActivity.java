...
public abstract class SubtaskActivity<TASK, SUBTASK> extends SmokeActivity<SmokeActivityDelegate> implements TaskListObserver<TASK> {
    ...
    private DetailsViewGroupController<SUBTASK> topDetailsController;
    private DetailsViewGroupController<SUBTASK> bottomDetailsController;

    protected abstract WorkflowConfiguration<TASK, SUBTASK> getWorkflowConfiguration();
