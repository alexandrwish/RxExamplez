...
public class StringFormat {
    ...
    public StringFormat append(String arg) {
        args.addElement(arg);
        return this;
    }

    public StringFormat append(Object obj) {
        args.addElement(obj.toString());
        return this;
    }

    public StringFormat append(boolean b) {
        args.addElement(String.valueOf(b));
        return this;
    }

    public StringFormat append(char c) {
        args.addElement(String.valueOf(c));
        return this;
    }

    public StringFormat append(int i) {
        args.addElement(String.valueOf(i));
        return this;
    }

    public StringFormat append(long l) {
        args.addElement(String.valueOf(l));
        return this;
    }
