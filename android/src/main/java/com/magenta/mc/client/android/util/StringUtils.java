...
public final class StringUtils {
    ...
    private static final SimpleDateFormat DATE_TIME_FORMAT = new SimpleDateFormat("dd/MM/yyyy HH:mm", Locale.UK);
    private static final SimpleDateFormat DATE_FORMAT = new SimpleDateFormat("dd/MM/yyyy", Locale.UK);
    private static final SimpleDateFormat DAY_AND_MONTH_FORMAT = new SimpleDateFormat("dd/MM", Locale.UK);
    ...
    public static String formatCost(Double cost) {
        return COST_FORMAT.format(cost != null ? cost : null);
    }
