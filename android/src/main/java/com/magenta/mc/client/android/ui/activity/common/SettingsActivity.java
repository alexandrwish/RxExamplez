...
public class SettingsActivity extends PreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ((McAndroidApplication) getApplication()).getThemeManager().applyThemeOnCreate(this);
    ...
    protected void onResume() {
        ((McAndroidApplication) getApplication()).getThemeManager().checkThemeOnResume(this);
        super.onResume();
    ...
    private void switchUiTheme(SharedPreferences sharedPreferences) {
        ...
        ThemeManager uiManager = ((McAndroidApplication) getApplication()).getThemeManager();
