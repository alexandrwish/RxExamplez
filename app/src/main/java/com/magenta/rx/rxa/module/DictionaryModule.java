...
public class DictionaryModule {
    ...
    @Provides
    @ActivityScope
    protected DefinitionListAdapter provieDictionaryListAdapter() {
        return new DefinitionListAdapter(new ArrayList<HashMap.Entry<String, List<DefinitionEntity>>>(), activity);
    }
}