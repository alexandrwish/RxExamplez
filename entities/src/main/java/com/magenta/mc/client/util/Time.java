...
public class Time {
    ...
    private final static int[] ofsFieldsA =
            {0, 4, 6, 9, 12, 15}; //XEP-0090 - DEPRECATED
    private final static int[] ofsFieldsB =
            {0, 5, 8, 11, 14, 17};//XEP-0202
    ...
    public static void init() {
        ...
        Time.setOffset(millisToHours(tz.getRawOffset()), millisToHours(tz.getDSTSavings()));
    }

    private static int millisToHours(long millis) {
